...
public class StreamsCookbookTest {
    ...
    private final List<Winner> tdfWinners = Arrays.asList(
            Winner.builder().year(2006).nationality("Spain").name("Óscar Pereiro")
                    .team("Caisse d'Epargne–Illes Balears").lengthKm(3657).winningTime(Duration.parse("PT89H40M27S")).daysInYellow(8).build(),
            Winner.builder().year(2007).nationality("Spain").name("Alberto Contador")
                    .team("Discovery Channel").lengthKm(3570).winningTime(Duration.parse("PT87H52M52S")).daysInYellow(4).build(),
            Winner.builder().year(2008).nationality("Spain").name("Carlos Sastre")
                    .team("Team CSC").lengthKm(3559).winningTime(Duration.parse("PT87H52M52S")).daysInYellow(5).build(),
            Winner.builder().year(2009).nationality("Spain").name("Alberto Contador")
                    .team("Astana").lengthKm(3459).winningTime(Duration.parse("PT85H48M35S")).daysInYellow(7).build(),
            Winner.builder().year(2010).nationality("Luxembourg").name("Andy Schleck")
                    .team("Team Saxo Bank").lengthKm(3642).winningTime(Duration.parse("PT91H59M27S")).daysInYellow(12).build(),
            Winner.builder().year(2011).nationality("Australia").name("Cadel Evans")
                    .team("BMC Racing Team").lengthKm(3430).winningTime(Duration.parse("PT86H12M22S")).daysInYellow(2).build(),
            Winner.builder().year(2012).nationality("Great Britain").name("Bradley Wiggins")
                    .team("Team Sky").lengthKm(3496).winningTime(Duration.parse("PT87H34M47S")).daysInYellow(14).build(),
            Winner.builder().year(2013).nationality("Great Britain").name("Chris Froome")
                    .team("Team Sky").lengthKm(3404).winningTime(Duration.parse("PT83H56M20S")).daysInYellow(14).build(),
            Winner.builder().year(2014).nationality("Italy").name("Vincenzo Nibali")
                    .team("Astana").lengthKm(3661).winningTime(Duration.parse("PT89H59M06S")).daysInYellow(19).build(),
            Winner.builder().year(2015).nationality("Great Britain").name("Chris Froome")
                    .team("Team Sky").lengthKm(3360).winningTime(Duration.parse("PT84H46M14S")).daysInYellow(16).build(),
            Winner.builder().year(2016).nationality("Great Britain").name("Chris Froome")
                    .team("Team Sky").lengthKm(3529).winningTime(Duration.parse("PT89H04M48S")).daysInYellow(14).build());
